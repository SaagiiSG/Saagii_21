...
export default function Nav(props){
    ...
    return(
        <motion.nav 
            ...
            <header className='z-10 group text-[20px] md:text-[24px] h-auto flex flex-col items-center justify-center sm:justify-start overflow-hidden  tracking-[6px] font-body font-normal  2xl:text-[28px]'>
