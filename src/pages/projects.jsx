    ...
    return(
        <artcile id='WORK' className="w-full h-screen flex flex-col justify-center items-center">
            ...
            <section className='w-full flex flex-col gap-0 justify-start items-center '>
                <motion.div ref={ref} className="group w-full flex flex-col justify-center items-center h-auto py-[16px] text-left border-t-[0.75px] border-slate-400 overflow-hidden pl-6 relative" 
                ...
                >
                    <h1 className="w-full text-[64px] md:w-[72%] sm:text-[80px] leading-[80px]  duration-300 relative font-body group-hover:text-[#cccbc8] group-hover:opacity-100">Xperience</h1>
                    <h2 className="md:w-[72%] tracking-[4px] font-body">founder, lead developer, ui/ux designer, video editor</h2>

                    <a href='https://www.instagram.com/_xperience___/' className="w-full text-left sm:absolute sm:opacity-0 sm:w-auto text-[20px]  sm:group-hover:block sm:group-hover:opacity-100 sm:group-hover:duration-[400ms] sm:group-hover:translate-x-[40%] font-body ease-out   sm:underline cursor-pointer opacity-80 font-light mt-2">instagram page {`>`}</a>
                </motion.div>
